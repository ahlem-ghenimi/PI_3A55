...
use App\Entity\Fournisseur; // Import the Fournisseur entity
...
class ProduitType extends AbstractType
{
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('quantite_vendue', null, [
                'constraints' => [
                    new NotBlank(['message' => 'La quantité vendue est requise']),
                ],
            ])
            ...
            ->add('fournisseur', EntityType::class, [
                ...
                'choice_label' => 'nom_fournisseur', // Adjust this to the actual property name in the Fournisseur entity
                'constraints' => [
                    new NotBlank(['message' => 'Le fournisseur est requis']),
                ],
            ])
